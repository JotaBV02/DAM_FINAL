...
import com.example.dam_examen_final_bravo.databinding.ActivityNotasBinding;
...
public class NotasActivity extends AppCompatActivity implements NotasInteractionListener{
    ...
    @Override
    public void editNotaClick(Notas nota) {

    }

    @Override
    public void eliminaNotaClick(Notas nota) {

    }

    @Override
    public void favoritaNotaClick(Notas nota) {
