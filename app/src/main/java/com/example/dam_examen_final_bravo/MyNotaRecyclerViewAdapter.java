...
import com.example.dam_examen_final_bravo.databinding.FragmentItemBinding;
...
public class MyNotaRecyclerViewAdapter extends RecyclerView.Adapter<MyNotaRecyclerViewAdapter.ViewHolder> {
    ...
    public MyNotaRecyclerViewAdapter(List<Notas> notaList, NotasInteractionListener mListener) {
